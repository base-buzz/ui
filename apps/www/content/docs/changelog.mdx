...
## March 2024 - Repository Cleanup

We've cleaned up the repository structure to improve maintainability and reduce confusion:

- Removed the unused v4 app to streamline the codebase
- Consolidated documentation into a clearer public/private structure
- Updated deployment configuration for better Vercel integration
...
<div class="mt-6 flex aspect-video w-full items-center justify-center overflow-hidden rounded-lg border bg-background shadow-sm">
  <svg
    viewBox="0 0 40 20"
    fill="none"
